package br.com.rafaelvieira.restarchetypebook_v2.integration.controller.withjson;
...
import br.com.rafaelvieira.restarchetypebook_v2.integration.vo.wrappers.WrapperPersonVO;
...
public class PersonControllerJsonTest extends AbstractIntegrationTest {
	...
	public void testFindAll() throws JsonMappingException, JsonProcessingException {
		...
		var content = given().spec(specification)
				.contentType(ConfigTest.CONTENT_TYPE_JSON)
				.accept(ConfigTest.CONTENT_TYPE_JSON)
